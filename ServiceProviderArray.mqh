...
#define SERVICE_PROVIDER_ARRAY_H
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
CServiceProviderArray::CServiceProviderArray(void) : m_step_resize(16),
                       m_data_total(0),
                       m_data_max(0),
                       m_sort_mode(-1)
  {
...
//| Destructor                                                       |
//+------------------------------------------------------------------+
CServiceProviderArray::~CServiceProviderArray(void)
  {
  }
//+------------------------------------------------------------------+
//| Method Set for variable m_step_resize                            |
//+------------------------------------------------------------------+
bool CServiceProviderArray::Step(const int step)
  {
//--- check
   if(step>0)
     {
...
//+------------------------------------------------------------------+
void CServiceProviderArray::Sort(const int mode)
  {
//--- check
   if(IsSorted(mode))
      return;
...
//+------------------------------------------------------------------+
bool CServiceProviderArray::Save(const int file_handle)
  {
//--- check handle
...
//+------------------------------------------------------------------+
bool CServiceProviderArray::Load(const int file_handle)
  {
//--- check handle
   if(file_handle!=INVALID_HANDLE)
     {
...
//+------------------------------------------------------------------+
template<typename T>
int CServiceProviderArray::Minimum(const T &data[],const int start,const int count) const
  {
   int real_count;
//--- check
   if(m_data_total<1)
...
//+------------------------------------------------------------------+
template<typename T>
int CServiceProviderArray::Maximum(const T &data[],const int start,const int count) const
  {
   int real_count;
//--- check
   if(m_data_total<1)
