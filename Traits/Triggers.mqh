...
#define CALLBACK_OBJ(__functions__) virtual CObject* callback_obj(const int id) { switch(id) { __functions__ } return NULL; }
...
#define CALLBACK_OBJ_P(__parameter__,__functions__) virtual CObject* callback_obj(const int id, __parameter__) { switch(id) { __functions__ } return NULL; }
...
#define CBFUNC_OBJ(__id__,__call__) case __id__: return __call__(); break;
